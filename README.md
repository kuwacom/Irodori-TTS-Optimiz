...
Then WebUI / CLI downloads such as `Aratako/Irodori-TTS-600M-v3-VoiceDesign` will be stored under `./models/hub`.
...
uv run --no-default-groups --extra legacy-cuda python gradio_app_voicedesign.py --server-name 0.0.0.0 --server-port 7861
```
